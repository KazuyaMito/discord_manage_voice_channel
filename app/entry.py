...
async def on_voice_state_update(member, before, after):
    ...
    if after.channel.id in channels.keys():
        ...
        tmp_channel = await guild.create_voice_channel(channel_name, user_limit=limit)
